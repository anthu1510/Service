...
$(function () {
    ...
    $('#nextday tbody').on("click","#btnstatus",function () {

        var data = table.row($(this).parents('tr')).data();
        StatusEdit(data[1]);
    });

    $('#nextday tbody').on("click","#btnedit",function () {
        var data = table.row($(this).parents('tr')).data();
        AllotmentEdit(data[1]);
    });

    $('#nextday tbody').on("click","#btnview",function () {
        var data = table.row($(this).parents('tr')).data();
...
// Handle click on checkbox
    $('#nextday tbody').on('click', 'input[type="checkbox"]', function(e){
...
// Handle click on table cells with checkboxes
    $('#nextday').on('click', 'tbody td, thead th:first-child', function(e){
...
// Handle click on "Select all" control
    $('thead input[name="select_all"]', table.table().container()).on('click', function(e){
        if(this.checked){
            $('#nextday tbody input[type="checkbox"]:not(:checked)').trigger('click');
        } else {
            $('#nextday tbody input[type="checkbox"]:checked').trigger('click');
        }
