...
$(function () {
    ...
    $('#compliant tbody').on("click","#btnstatus",function () {

        var data = table.row($(this).parents('tr')).data();
        StatusEdit(data[1]);
    });

    $('#compliant tbody').on("click","#btnedit",function () {
        var data = table.row($(this).parents('tr')).data();
        AllotmentEdit(data[1]);
    });

    $('#compliant tbody').on("click","#btnview",function () {
        var data = table.row($(this).parents('tr')).data();
...
$('#compliant tbody').on('click', 'input[type="checkbox"]', function(e){
...
$('#compliant').on('click', 'tbody td, thead th:first-child', function(e){
...
$('thead input[name="select_all"]', table.table().container()).on('click', function(e){
    if(this.checked){
        $('#compliant tbody input[type="checkbox"]:not(:checked)').trigger('click');
    } else {
        $('#compliant tbody input[type="checkbox"]:checked').trigger('click');
    }
