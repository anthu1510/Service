...
require_once ('profile/newuser_table_list.php');
...
require_once ('profile/newuser_datatable_js.php');

require_once ('common/body_close.php');

require_once ('profile/user_edit_form.php');
require_once ('profile/passwordchange_form_modal.php');
require_once ('profile/user_view_details_modal.php');
