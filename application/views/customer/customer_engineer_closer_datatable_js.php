<script>
    var ajaxphpurl = "<?php echo site_url('user/customercallcloserserverside'); ?>";
    var redirecturl = "<?php echo site_url('user/clientcomplientlist'); ?>";
    var editurl = "<?php echo site_url('customer/customeredit'); ?>";
    var viewurl = "<?php echo site_url('user/customerview'); ?>";
