...
require_once('customer/clientcompliant_table_list.php');
...
require_once ('customer/clientcompliant_view_details_modal.php');
...
require_once ('customer/cientcompliant_closer_datatable_js.php');
